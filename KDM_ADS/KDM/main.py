...
from get_dataset import PreTrainDataset_prepared, pre_dataset_add_feature
...
def main():
    ...
    # 人工特征 分开归一化
    # X_train, Y_train = pre_dataset_add_feature()

    X_train, X_val, Y_train, Y_val = train_test_split(
        X_train, Y_train, test_size=0.05, random_state=30
    )
